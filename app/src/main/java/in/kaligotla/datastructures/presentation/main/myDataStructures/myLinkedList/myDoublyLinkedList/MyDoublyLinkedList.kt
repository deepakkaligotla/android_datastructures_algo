...
@Composable
fun MyDoublyLinkedList(
    drawerState: DrawerState,
    viewModel: MyDoublyLinkedListViewModel = hiltViewModel()
) {
                    ...
                    Row(
                        ...
                        Column(
                            ...
                            TextField(value = userInputSize, onValueChange = {
                                userInputSize = it
                                if (userInputSize.isDigitsOnly() && userInputSize.isNotEmpty() && userInputSize.isNotBlank())
                                    viewModel.createNodeStructureOfExistingData(
                                        userInputSize.toInt()
                                    ) else if (userInputSize == "") viewModel.createNodeStructureOfExistingData(
                                    0
                                )
                            ...
                            Column {
                                ...
                                Row {
                                    Button(onClick = {
                                        ...
                                        viewModel.insertAtFirst(userInputValue)
                            ...
                            Column {
                                ...
                                Row {
                                    Button(onClick = {
                                        ...
                                        viewModel.insertAtLast(userInputValue)
